...
private:
    ...
    bool m_performedFullLayoutOnce : 1 { false }; // Needed to distinguish between when we perform a full pass of layout and everHadLayout (which can be set be content visibility for skipped content).
