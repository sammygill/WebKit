...
{
    if (beingDestroyed() || !m_performedFullLayoutOnce) {
        ASSERT(m_layoutAttributes.isEmpty());
...
void RenderSVGText::layout()
{
    ...
    auto layoutChanged = m_performedFullLayoutOnce && selfNeedsLayout();
    ...
    clearNeedsLayout();
    m_performedFullLayoutOnce = true;
}
